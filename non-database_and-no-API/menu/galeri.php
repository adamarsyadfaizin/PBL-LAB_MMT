...
<head>
    ...
    <style type="text/css">
        /* ---
           ...
           + Tambahan style untuk Halaman Galeri
        --- */
        ...
        *::after {
        ...
        /* (Tidak ada .primary-content atau .sidebar di halaman ini) */

        /* ==== 6 & 7 (Style dasar dari file lain) ==== */
        .facility-item {
            display: grid;
        ...
        /* ==== 8. BARU: Style untuk Halaman Galeri ==== */
        
        /* (Style .filter-bar di-reuse dari halaman berita) */
        .filter-bar {
            display: flex;
        ...
        /* Overlay untuk ikon (foto, video, animasi) */
        .gallery-item .overlay {
            ...
            width: 100%;
            height: 100%;
            background: rgba(0, 59, 142, 0.7); /* --color-primary + opacity */
            color: white;
            display: flex;
            align-items: center;
            ...
            pointer-events: none; /* Agar klik tembus ke <a> */
        }
        ...
        /* (Tampilan Lightbox disimulasikan oleh hover ini) */
        ...
        /* ==== 9. Footer (MODIFIKASI: Sama seperti berita.php) ==== */
        .site-footer {
            background: var(--color-primary);
            color: var(--color-white);
            padding-top: 60px;
...
<body id="top">
    ...
    <!-- MODIFIKASI: Footer sama seperti berita.php -->
