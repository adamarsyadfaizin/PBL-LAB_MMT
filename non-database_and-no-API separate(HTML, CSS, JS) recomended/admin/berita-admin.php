                        ...
                        <tr>
                            ...
                            <td>
                                <div class="table-actions">
                                    <button class="btn-icon btn-edit" onclick="editBerita(1)" title="Edit"><i class="bi bi-pen-fill"></i></button>
                                    <button class="btn-icon btn-delete" onclick="deleteBerita(1)" title="Hapus"><i class="bi bi-trash3-fill"></i></button>
                                    <button class="btn-icon" onclick="viewBerita(1)" title="Lihat" style="background: #6c757d; color: white;"><i class="bi bi-eyeglasses"></i></button>
                                </div>
                            </td>
                        </tr>
                        <tr>
