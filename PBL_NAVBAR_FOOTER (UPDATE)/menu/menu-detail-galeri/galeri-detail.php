...
<head>
    ...
    <style>
        ...
        /* Meta Info */
        .article-meta-detail { margin-bottom: 20px; }
        ...
        <div class="container">
            <div class="primary-content">
                ...
                <?php if ($media['type'] === 'video'): ?>
                    <video controls class="detail-article-banner">
                        <source src="<?= $url; ?>" type="video/mp4">
                        Browser Anda tidak mendukung tag video.
                    </video>
                <?php else: ?>
                    <img src="<?= $url; ?>" alt="<?= $title; ?>" class="detail-article-banner">
                <?php endif; ?>

                <!-- Deskripsi -->
                <?php if (!empty($deskripsi)): ?>
                    <p class="media-description"><?= nl2br($deskripsi); ?></p>
                <?php endif; ?>
